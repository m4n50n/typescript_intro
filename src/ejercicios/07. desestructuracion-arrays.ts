...
// Desestructuración de array (se hace por posición y no por nombre como en los objetos, por l oque la primera variable corresponderá con el elemento de la primera posición)
